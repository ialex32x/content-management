...
namespace Iris.ContentManagement.Utility
{
    public class ChunkedStream : Stream
    {
        ...
        public ChunkedStream(ITransform transform, Stream stream, long rsize, int chunkSize = 4096, bool leaveOpen = false)
        {
        ...
        public static int GetChunkSize(int chunkSize) => chunkSize < 512 ? 512 : (chunkSize - chunkSize % 512);
        ...
        private int ReadChunk(long chunkBegin)
        {
            ...
            var block = _transform.Transform(_chunk, 0, read);
